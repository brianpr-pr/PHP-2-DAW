...
<body>
    ...
    <form method="POST">
        ...
        <input type="email" name="emailUsuario" value='<?php echo $_SESSION['emailUsuario'];?>'>
        <br>
    ...
    <?php
        ...
        $validForm = true;
            ...
            if(!emailValidation( $_POST['emailUsuario'] ) ){
                echo "<h2>Invalid email direction</h2>";
                $_POST['emailUsuario'] = null;
                $validForm = false;
            } 

            if(!passwordValidation($_POST['contraseñaUsuario'],$_POST['contraseñaUsuarioDos'])){
                echo "<h2>Error passwords are not equal</h2>";
                $_POST['contraseñaUsuario'] = null;
                $_POST['contraseñaUsuarioDos'] = null;
                $validForm = false;
            }
